  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center px-16 text-center overflow-hidden noise-overlay vignette">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[700px] bg-gradient-radial from-accent-blue/[0.1] via-accent-blue/[0.03] to-transparent blur-3xl glow-animate" />
        {/* Accent glows */}
        <div className="absolute top-[15%] right-[20%] w-[400px] h-[400px] bg-gradient-radial from-accent-blue/[0.05] to-transparent blur-3xl" />
        <div className="absolute bottom-[20%] left-[15%] w-[350px] h-[350px] bg-gradient-radial from-accent-amber/[0.02] to-transparent blur-3xl" />
        {/* Grid pattern */}
        <div
      ...
      <div className="absolute top-[40%] left-0 w-24 h-px bg-gradient-to-r from-transparent via-accent-blue-light/[0.2] to-transparent" />
      <div className="absolute bottom-[40%] right-0 w-24 h-px bg-gradient-to-l from-transparent via-accent-blue-light/[0.2] to-transparent" />

      {/* Corner decorations - enhanced */}
      <div className="absolute top-10 left-10">
        <div className="w-24 h-24 border-l-2 border-t-2 border-white/[0.08]" />
        <div className="absolute top-3 left-3 flex gap-1.5">
          <div className="w-2 h-2 rounded-full bg-accent-blue-light/40" />
          <div className="w-2 h-2 rounded-full bg-accent-blue-light/25" />
          <div className="w-2 h-2 rounded-full bg-accent-blue-light/10" />
        </div>
      </div>
