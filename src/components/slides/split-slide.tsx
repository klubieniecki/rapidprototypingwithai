  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden noise-overlay">
      ...
      <div className="relative w-[42%] flex flex-col justify-center px-12 pt-28 pb-12">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-accent-blue/[0.08] via-transparent to-accent-blue/[0.05]" />
        <div className="absolute top-[30%] left-[20%] w-[300px] h-[300px] bg-gradient-radial from-accent-blue/[0.06] to-transparent blur-3xl" />
        ...
        <blockquote className="relative z-10 max-w-lg">
          ...
          {slide.leftPanel.attribution && (
            <cite className="mt-5 flex items-center gap-3 not-italic">
              <span className="h-px w-8 bg-accent-blue-light/40" />
              <span className="font-code text-sm font-medium text-accent-blue-light tracking-wide">
                {slide.leftPanel.attribution}
              </span>
            </cite>
          )}
        ...
        {slide.leftPanel.stat && (
          <div className="relative z-10 mt-10 pt-8 border-t border-white/[0.08]">
            <div className="flex items-baseline gap-2">
              <span className="text-[clamp(3rem,5vw,4.5rem)] font-bold text-accent-blue-light leading-none tracking-tight">
                {slide.leftPanel.stat}
              </span>
            </div>
        ...
        {/* Bottom accent */}
        <div className="absolute bottom-8 left-12 w-24 h-px bg-gradient-to-r from-accent-blue-light/30 to-transparent" />
      </div>
      ...
      <div className="absolute left-[42%] top-24 bottom-8 w-px">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-accent-blue-light/40 shadow-[0_0_12px_rgba(123,116,228,0.3)]" />
      </div>
      ...
      <div className="relative flex-1 flex flex-col justify-center pl-14 pr-16 pt-28 pb-12">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(22, 18, 211, 0.6) 1px, transparent 1px),
                              linear-gradient(rgba(22, 18, 211, 0.6) 1px, transparent 1px)`,
        ...
        <div className="relative z-10 space-y-7">
          {slide.rightPanel.numberedItems.map((item, i) => (
            <div key={i} className="flex items-start gap-5 group">
              {/* Large number badge */}
              <div className="shrink-0 w-14 h-14 rounded-xl bg-accent-blue/[0.08] border border-accent-blue-light/20 flex items-center justify-center shadow-[0_0_20px_rgba(123,116,228,0.05)] group-hover:bg-accent-blue/[0.12] group-hover:border-accent-blue-light/30 transition-all duration-300">
                <span className="font-code text-2xl font-bold text-accent-blue-light">
                  {i + 1}
                </span>
              </div>
